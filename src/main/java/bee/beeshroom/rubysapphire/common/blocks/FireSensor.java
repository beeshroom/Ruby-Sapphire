...
public class FireSensor extends AbstractPressurePlateBlock
{
	  public static final BooleanProperty POWERED = BlockStateProperties.POWERED;
	   private final PressurePlateBlock.Sensitivity sensitivity;
	
	  public FireSensor(PressurePlateBlock.Sensitivity p_i48348_1_, AbstractBlock.Properties p_i48348_2_) {
	      super(p_i48348_2_);
